...
public class GetUserEntriesQueryHandler : IRequestHandler<GetUserEntriesQueryRequest,PagedViewModel<GetUserEntriesQueryResponse>>
{
    ...
    public async Task<PagedViewModel<GetUserEntriesQueryResponse>> Handle(GetUserEntriesQueryRequest request, CancellationToken cancellationToken)
    {
